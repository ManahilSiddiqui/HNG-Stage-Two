 ...
 *
 */
export declare function useNextRouterViewTransitions({ events }: UseNextRouterViewTransitionsProps): void;
/**
 ...
 */
export declare const EnableNextAppRouterViewTransitions: FC;
